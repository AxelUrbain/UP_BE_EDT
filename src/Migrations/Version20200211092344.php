...
final class Version20200211092344 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rfid (id NUMBER(10) NOT NULL, nom VARCHAR2(255) DEFAULT NULL NULL, prenom VARCHAR2(255) DEFAULT NULL NULL, password VARCHAR2(255) DEFAULT NULL NULL, PRIMARY KEY(id))');
    }
